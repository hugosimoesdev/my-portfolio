...
export default function Home() {
  return (
    <main className="flex flex-col flex-1 mt-16 mx-52 gap-14 items-start">
      <div className="flex gap-3 items-center border rounded-3xl py-2 px-4">
        <HomeIcon size={16} />
      ...
      <p className="text-zinc-400">
        Hello and welcome to my website. Here, you'll discover everything about
        my professional journey. <br/>Feel free to get to know me better. <br/><br/>I'm a
